...
data<-readRDS("data_DiebnerEtAl.rds")
head(data)
...
fit2<-readRDS("fit2019_2_s3_G-G-G-G.rds")
...
## Load data including the AUCs:
  data_auc <- readRDS("AUC_data_Fig2A.rds")
  # data_auc <- readRDS("AUC_data_Fig2A_48.rds")
  # dim(data_auc)
  par(mfrow = c(2, 2))
  fit2b <- readRDS("fit2019_2_s3_1-1-G-G.rds")
...
```{r eval=TRUE, include=TRUE, echo=FALSE, fig.width=14, fig.height=20}
  ...
  plot(fit2, type="average", legendPos = c(55.0,3.32), cex.legend=0.8, log="", legend=T, 
       pch=c(19,17,19,17,19,17), col=c(2,2,4,4,1,1), lty=c(1,2,1,2,1,2), xlim=c(0,50), ylim=c(3.2,3.65), 
       xlab="time [h]", ylab="log(T(t))", main="s=3")
  fit2a<-readRDS("fit2019_2_s3_1-G-G-G.rds")
  ...
  plot(fit2b, type="average", legendPos = c(55.0,3.32), cex.legend=0.8, log="", legend=T, 
       pch=c(19,17,19,17,19,17), col=c(2,2,4,4,1,1), lty=c(1,2,1,2,1,2), xlim=c(0,50), ylim=c(3.2,3.65), 
       xlab="time [h]", ylab="log(T(t))", main="s=3")
  fit2c<-readRDS("fit2019_2_s3_1-1-1-G.rds")
  plot(fit2c, type="average", legendPos = c(55.0,3.32), cex.legend=0.8, log="", legend=T, 
       pch=c(19,17,19,17,19,17), col=c(2,2,4,4,1,1), lty=c(1,2,1,2,1,2), xlim=c(0,50), ylim=c(3.2,3.65), 
       xlab="time [h]", ylab="log(T(t))", main="s=3")
  fit2d<-readRDS("fit2019_2_s3_1-1-G-1.rds")
...
fit3<-readRDS("fit2019_2_s4_G-G-G-G.rds")
...
p<-NULL
fit2a_Casp1C284AvsCasp1C284AxRIP2KO<-readRDS("fit2019_2_Casp1C284AvsCasp1C284AxRIP2KO_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1C284AvsCasp1C284AxRIP2KO,fit2a,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1C284AvsCasp1KO<-readRDS("fit2019_2_Casp1C284AvsCasp1KO_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1C284AvsCasp1KO,fit2a,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1C284AvsCasp1KOxRIP2KO<-readRDS("fit2019_2_Casp1C284AvsCasp1KOxRIP2KO_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1C284AvsCasp1KOxRIP2KO,fit2a,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1C284AvsCasp1WT<-readRDS("fit2019_2_Casp1C284AvsCasp1WT_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1C284AvsCasp1WT,fit2a,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1C284AvsCasp1WTxRIP2KO<-readRDS("fit2019_2_Casp1C284AvsCasp1WTxRIP2KO_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1C284AvsCasp1WTxRIP2KO,fit2a,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1C284AxRIP2KOvsCasp1KO <- readRDS("fit2019_2_Casp1C284AxRIP2KOvsCasp1KO_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1C284AxRIP2KOvsCasp1KO,fit2a,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1C284AxRIP2KOvsCasp1KOxRIP2KO <- readRDS("fit2019_2_Casp1C284AxRIP2KOvsCasp1KOxRIP2KO_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1C284AxRIP2KOvsCasp1KOxRIP2KO,fit2a,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1C284AxRIP2KOvsCasp1WT <- readRDS("fit2019_2_Casp1C284AxRIP2KOvsCasp1WT_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1C284AxRIP2KOvsCasp1WT,fit2a,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1C284AxRIP2KOvsCasp1WTxRIP2KO <- readRDS("fit2019_2_Casp1C284AxRIP2KOvsCasp1WTxRIP2KO_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1C284AxRIP2KOvsCasp1WTxRIP2KO,fit2a,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1KOvsCasp1KOxRIP2KO <- readRDS("fit2019_2_Casp1KOvsCasp1KOxRIP2KO_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1KOvsCasp1KOxRIP2KO,fit2a,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1KOvsCasp1WT <- readRDS("fit2019_2_Casp1KOvsCasp1WT_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1KOvsCasp1WT,fit2a,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1KOvsCasp1WTxRIP2KO <- readRDS("fit2019_2_Casp1KOvsCasp1WTxRIP2KO_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1KOvsCasp1WTxRIP2KO,fit2a,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1KOxRIP2KOvsCasp1WT <- readRDS("fit2019_2_Casp1KOxRIP2KOvsCasp1WT_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1KOxRIP2KOvsCasp1WT,fit2a,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1KOxRIP2KOvsCasp1WTxRIP2KO <- readRDS("fit2019_2_Casp1KOxRIP2KOvsCasp1WTxRIP2KO_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1KOxRIP2KOvsCasp1WTxRIP2KO,fit2a,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1WTvsCasp1WTxRIP2KO <- readRDS("fit2019_2_Casp1WTvsCasp1WTxRIP2KO_s3_1-G-G-G.rds")
...
fit2a_reduced<-readRDS("fit_6ts1_s3_1-G-G-G.rds")
...
p<-NULL
fit2a_Casp1C284AvsCasp1C284AxRIP2KO<-readRDS("fit_6ts1_Casp1C284AvsCasp1C284AxRIP2KO_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1C284AvsCasp1C284AxRIP2KO,fit2a_reduced,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1C284AvsCasp1KO<-readRDS("fit_6ts1_Casp1C284AvsCasp1KO_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1C284AvsCasp1KO,fit2a_reduced,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1C284AvsCasp1KOxRIP2KO<-readRDS("fit_6ts1_Casp1C284AvsCasp1KOxRIP2KO_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1C284AvsCasp1KOxRIP2KO,fit2a_reduced,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1C284AvsCasp1WT<-readRDS("fit_6ts1_Casp1C284AvsCasp1WT_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1C284AvsCasp1WT,fit2a_reduced,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1C284AvsCasp1WTxRIP2KO<-readRDS("fit_6ts1_Casp1C284AvsCasp1WTxRIP2KO_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1C284AvsCasp1WTxRIP2KO,fit2a_reduced,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1C284AxRIP2KOvsCasp1KO <- readRDS("fit_6ts1_Casp1C284AxRIP2KOvsCasp1KO_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1C284AxRIP2KOvsCasp1KO,fit2a_reduced,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1C284AxRIP2KOvsCasp1KOxRIP2KO <- readRDS("fit_6ts1_Casp1C284AxRIP2KOvsCasp1KOxRIP2KO_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1C284AxRIP2KOvsCasp1KOxRIP2KO,fit2a_reduced,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1C284AxRIP2KOvsCasp1WT <- readRDS("fit_6ts1_Casp1C284AxRIP2KOvsCasp1WT_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1C284AxRIP2KOvsCasp1WT,fit2a_reduced,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1C284AxRIP2KOvsCasp1WTxRIP2KO <- readRDS("fit_6ts1_Casp1C284AxRIP2KOvsCasp1WTxRIP2KO_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1C284AxRIP2KOvsCasp1WTxRIP2KO,fit2a_reduced,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1KOvsCasp1KOxRIP2KO <- readRDS("fit_6ts1_Casp1KOvsCasp1KOxRIP2KO_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1KOvsCasp1KOxRIP2KO,fit2a_reduced,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1KOvsCasp1WT <- readRDS("fit_6ts1_Casp1KOvsCasp1WT_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1KOvsCasp1WT,fit2a_reduced,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1KOvsCasp1WTxRIP2KO <- readRDS("fit_6ts1_Casp1KOvsCasp1WTxRIP2KO_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1KOvsCasp1WTxRIP2KO,fit2a_reduced,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1KOxRIP2KOvsCasp1WT <- readRDS("fit_6ts1_Casp1KOxRIP2KOvsCasp1WT_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1KOxRIP2KOvsCasp1WT,fit2a_reduced,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1KOxRIP2KOvsCasp1WTxRIP2KO <- readRDS("fit_6ts1_Casp1KOxRIP2KOvsCasp1WTxRIP2KO_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1KOxRIP2KOvsCasp1WTxRIP2KO,fit2a_reduced,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1WTvsCasp1WTxRIP2KO <- readRDS("fit_6ts1_Casp1WTvsCasp1WTxRIP2KO_s3_1-G-G-G.rds")
...
fit2a_reduced<-readRDS("fit_6ts2_s3_1-G-G-G.rds")
plot(fit2a_reduced, type="average", legendPos = c(55.0,3.32), cex.legend=0.8, log="", legend=T, pch=c(19,17,19,17,19,17), col=c(2,2,4,4,1,1), lty=c(1,2,1,2,1,2), xlim=c(0,50), ylim=c(3.2,3.65), xlab="time [h]", ylab="log(T(t))", main="s=3")

p<-NULL
fit2a_Casp1C284AvsCasp1C284AxRIP2KO<-readRDS("fit_6ts2_Casp1C284AvsCasp1C284AxRIP2KO_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1C284AvsCasp1C284AxRIP2KO,fit2a_reduced,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1C284AvsCasp1KO<-readRDS("fit_6ts2_Casp1C284AvsCasp1KO_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1C284AvsCasp1KO,fit2a_reduced,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1C284AvsCasp1KOxRIP2KO<-readRDS("fit_6ts2_Casp1C284AvsCasp1KOxRIP2KO_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1C284AvsCasp1KOxRIP2KO,fit2a_reduced,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1C284AvsCasp1WT<-readRDS("fit_6ts2_Casp1C284AvsCasp1WT_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1C284AvsCasp1WT,fit2a_reduced,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1C284AvsCasp1WTxRIP2KO<-readRDS("fit_6ts2_Casp1C284AvsCasp1WTxRIP2KO_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1C284AvsCasp1WTxRIP2KO,fit2a_reduced,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1C284AxRIP2KOvsCasp1KO <- readRDS("fit_6ts2_Casp1C284AxRIP2KOvsCasp1KO_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1C284AxRIP2KOvsCasp1KO,fit2a_reduced,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1C284AxRIP2KOvsCasp1KOxRIP2KO <- readRDS("fit_6ts2_Casp1C284AxRIP2KOvsCasp1KOxRIP2KO_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1C284AxRIP2KOvsCasp1KOxRIP2KO,fit2a_reduced,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1C284AxRIP2KOvsCasp1WT <- readRDS("fit_6ts2_Casp1C284AxRIP2KOvsCasp1WT_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1C284AxRIP2KOvsCasp1WT,fit2a_reduced,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1C284AxRIP2KOvsCasp1WTxRIP2KO <- readRDS("fit_6ts2_Casp1C284AxRIP2KOvsCasp1WTxRIP2KO_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1C284AxRIP2KOvsCasp1WTxRIP2KO,fit2a_reduced,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1KOvsCasp1KOxRIP2KO <- readRDS("fit_6ts2_Casp1KOvsCasp1KOxRIP2KO_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1KOvsCasp1KOxRIP2KO,fit2a_reduced,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1KOvsCasp1WT <- readRDS("fit_6ts2_Casp1KOvsCasp1WT_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1KOvsCasp1WT,fit2a_reduced,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1KOvsCasp1WTxRIP2KO <- readRDS("fit_6ts2_Casp1KOvsCasp1WTxRIP2KO_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1KOvsCasp1WTxRIP2KO,fit2a_reduced,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1KOxRIP2KOvsCasp1WT <- readRDS("fit_6ts2_Casp1KOxRIP2KOvsCasp1WT_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1KOxRIP2KOvsCasp1WT,fit2a_reduced,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1KOxRIP2KOvsCasp1WTxRIP2KO <- readRDS("fit_6ts2_Casp1KOxRIP2KOvsCasp1WTxRIP2KO_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1KOxRIP2KOvsCasp1WTxRIP2KO,fit2a_reduced,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1WTvsCasp1WTxRIP2KO <- readRDS("fit_6ts2_Casp1WTvsCasp1WTxRIP2KO_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1WTvsCasp1WTxRIP2KO,fit2a_reduced,test="LRT")
p<-c(p,a$`p value`[2])
...
fit2a_reduced<-readRDS("fit_6ts3_s3_1-G-G-G.rds")
plot(fit2a_reduced, type="average", legendPos = c(55.0,3.32), cex.legend=0.8, log="", legend=T, pch=c(19,17,19,17,19,17), col=c(2,2,4,4,1,1), lty=c(1,2,1,2,1,2), xlim=c(0,50), ylim=c(3.2,3.65), xlab="time [h]", ylab="log(T(t))", main="s=3")

p<-NULL
fit2a_Casp1C284AvsCasp1C284AxRIP2KO<-readRDS("fit_6ts3_Casp1C284AvsCasp1C284AxRIP2KO_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1C284AvsCasp1C284AxRIP2KO,fit2a_reduced,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1C284AvsCasp1KO<-readRDS("fit_6ts3_Casp1C284AvsCasp1KO_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1C284AvsCasp1KO,fit2a_reduced,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1C284AvsCasp1KOxRIP2KO<-readRDS("fit_6ts3_Casp1C284AvsCasp1KOxRIP2KO_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1C284AvsCasp1KOxRIP2KO,fit2a_reduced,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1C284AvsCasp1WT<-readRDS("fit_6ts3_Casp1C284AvsCasp1WT_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1C284AvsCasp1WT,fit2a_reduced,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1C284AvsCasp1WTxRIP2KO<-readRDS("fit_6ts3_Casp1C284AvsCasp1WTxRIP2KO_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1C284AvsCasp1WTxRIP2KO,fit2a_reduced,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1C284AxRIP2KOvsCasp1KO <- readRDS("fit_6ts3_Casp1C284AxRIP2KOvsCasp1KO_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1C284AxRIP2KOvsCasp1KO,fit2a_reduced,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1C284AxRIP2KOvsCasp1KOxRIP2KO <- readRDS("fit_6ts3_Casp1C284AxRIP2KOvsCasp1KOxRIP2KO_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1C284AxRIP2KOvsCasp1KOxRIP2KO,fit2a_reduced,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1C284AxRIP2KOvsCasp1WT <- readRDS("fit_6ts3_Casp1C284AxRIP2KOvsCasp1WT_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1C284AxRIP2KOvsCasp1WT,fit2a_reduced,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1C284AxRIP2KOvsCasp1WTxRIP2KO <- readRDS("fit_6ts3_Casp1C284AxRIP2KOvsCasp1WTxRIP2KO_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1C284AxRIP2KOvsCasp1WTxRIP2KO,fit2a_reduced,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1KOvsCasp1KOxRIP2KO <- readRDS("fit_6ts3_Casp1KOvsCasp1KOxRIP2KO_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1KOvsCasp1KOxRIP2KO,fit2a_reduced,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1KOvsCasp1WT <- readRDS("fit_6ts3_Casp1KOvsCasp1WT_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1KOvsCasp1WT,fit2a_reduced,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1KOvsCasp1WTxRIP2KO <- readRDS("fit_6ts3_Casp1KOvsCasp1WTxRIP2KO_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1KOvsCasp1WTxRIP2KO,fit2a_reduced,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1KOxRIP2KOvsCasp1WT <- readRDS("fit_6ts3_Casp1KOxRIP2KOvsCasp1WT_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1KOxRIP2KOvsCasp1WT,fit2a_reduced,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1KOxRIP2KOvsCasp1WTxRIP2KO <- readRDS("fit_6ts3_Casp1KOxRIP2KOvsCasp1WTxRIP2KO_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1KOxRIP2KOvsCasp1WTxRIP2KO,fit2a_reduced,test="LRT")
p<-c(p,a$`p value`[2])

fit2a_Casp1WTvsCasp1WTxRIP2KO <- readRDS("fit_6ts3_Casp1WTvsCasp1WTxRIP2KO_s3_1-G-G-G.rds")
a<-anova(fit2a_Casp1WTvsCasp1WTxRIP2KO,fit2a_reduced,test="LRT")
p<-c(p,a$`p value`[2])
